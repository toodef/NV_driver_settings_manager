...
void nv_api::init_map()
{
   ...
   dword_map[OGL_AA_LINE_GAMMA_ID] = map_list_of("DISABLED", OGL_AA_LINE_GAMMA_DISABLED)
                                                ("ENABLED" , OGL_AA_LINE_GAMMA_ENABLED )
                                                ("MIN"     , OGL_AA_LINE_GAMMA_ENABLED )
                                                ("MAX"     , OGL_AA_LINE_GAMMA_ENABLED )
                                                ;

   //"Deep color for 3D applications"
   dword_map[OGL_DEEP_COLOR_SCANOUT_ID] = map_list_of("DISABLE", OGL_DEEP_COLOR_SCANOUT_DISABLE)
   ...
   dword_map[OGL_DEFAULT_SWAP_INTERVAL_ID] = map_list_of("TEAR"          , OGL_DEFAULT_SWAP_INTERVAL_TEAR          )
   ...
   dword_map[OGL_DEFAULT_SWAP_INTERVAL_FRACTIONAL_ID] = map_list_of("ZERO_SCANLINES"             , OGL_DEFAULT_SWAP_INTERVAL_FRACTIONAL_ZERO_SCANLINES             )
   ...
   dword_map[OGL_DEFAULT_SWAP_INTERVAL_SIGN_ID] = map_list_of("POSITIVE", OGL_DEFAULT_SWAP_INTERVAL_SIGN_POSITIVE)
                                                             ("NEGATIVE", OGL_DEFAULT_SWAP_INTERVAL_SIGN_NEGATIVE)
                                                             ;

   //"Event Log Severity Threshold. This controls which events are logged."
   dword_map[OGL_EVENT_LOG_SEVERITY_THRESHOLD_ID] = map_list_of("DISABLE"    , OGL_EVENT_LOG_SEVERITY_THRESHOLD_DISABLE    )
   ...
   string_map[OGL_IMPLICIT_GPU_AFFINITY_ID] = list_of(string((const char *)OGL_IMPLICIT_GPU_AFFINITY_ENV_VAR   ))
                                                     (string((const char *)OGL_IMPLICIT_GPU_AFFINITY_AUTOSELECT))
                                                     ;

   //"Buffer-flipping mode"
   dword_map[OGL_FORCE_BLIT_ID] = map_list_of("ON" , OGL_FORCE_BLIT_ON )
                                             ("OFF", OGL_FORCE_BLIT_OFF)
                                             ;

   //"Force Stereo shuttering"
   dword_map[OGL_FORCE_STEREO_ID] = map_list_of("OFF", OGL_FORCE_STEREO_OFF)
   ...
   dword_map[OGL_MULTIMON_ID] = map_list_of("SINGLE_MONITOR"         , OGL_MULTIMON_SINGLE_MONITOR         )
   ...
   dword_map[OGL_OVERLAY_PIXEL_TYPE_ID] = map_list_of("NONE"       , OGL_OVERLAY_PIXEL_TYPE_NONE       )
   ...
   //"Enable overlay"
   dword_map[OGL_OVERLAY_SUPPORT_ID] = map_list_of("OFF"     , OGL_OVERLAY_SUPPORT_OFF     )
                                                  ("ON"      , OGL_OVERLAY_SUPPORT_ON      )
                                                  ("FORCE_SW", OGL_OVERLAY_SUPPORT_FORCE_SW)
                                                  ;

   //"High level control of the rendering quality on OpenGL"
   dword_map[OGL_QUALITY_ENHANCEMENTS_ID] = map_list_of("HQUAL", OGL_QUALITY_ENHANCEMENTS_HQUAL)
   ...
   dword_map[OGL_SINGLE_BACKDEPTH_BUFFER_ID] = map_list_of("DISABLE"       , OGL_SINGLE_BACKDEPTH_BUFFER_DISABLE       )
                                                          ("ENABLE"        , OGL_SINGLE_BACKDEPTH_BUFFER_ENABLE        )
                                                          ("USE_HW_DEFAULT", OGL_SINGLE_BACKDEPTH_BUFFER_USE_HW_DEFAULT)
                                                          ;

   //"Threaded optimization"
   dword_map[OGL_THREAD_CONTROL_ID] = map_list_of("ENABLE"          , OGL_THREAD_CONTROL_ENABLE          )
   ...
   //"Triple buffering"
   dword_map[OGL_TRIPLE_BUFFER_ID] = map_list_of("DISABLE", OGL_TRIPLE_BUFFER_DISABLED)
                                                ("ENABLE" , OGL_TRIPLE_BUFFER_ENABLED )
                                                ;


   //"controls video-editing mode for OpenGL"
   dword_map[OGL_VIDEO_EDITING_MODE_ID] = map_list_of("DISABLE", OGL_VIDEO_EDITING_MODE_DISABLE)
                                                     ("ENABLE" , OGL_VIDEO_EDITING_MODE_ENABLE )
                                                     ;

   //"Antialiasing - Behavior Flags"
   dword_map[AA_BEHAVIOR_FLAGS_ID] = map_list_of("NONE"                                  , AA_BEHAVIOR_FLAGS_NONE                                  )
   ...
   dword_map[AA_MODE_ALPHATOCOVERAGE_ID] = map_list_of("MASK", AA_MODE_ALPHATOCOVERAGE_MODE_MASK)
   ...
   dword_map[AA_MODE_GAMMACORRECTION_ID] = map_list_of("MASK"         , AA_MODE_GAMMACORRECTION_MASK         )
   ...
   dword_map[AA_MODE_METHOD_ID] = map_list_of("NONE"                            , AA_MODE_METHOD_NONE                            )
   ...
   dword_map[AA_MODE_REPLAY_ID] = map_list_of("SAMPLES_MASK"              , AA_MODE_REPLAY_SAMPLES_MASK              )
   ...
   //"Antialiasing - Mode"
   dword_map[AA_MODE_SELECTOR_ID] = map_list_of("MASK"       , AA_MODE_SELECTOR_MASK       )
   ...
   //"Antialiasing - SLI AA"
   dword_map[AA_MODE_SELECTOR_SLIAA_ID] = map_list_of("DISABLED", AA_MODE_SELECTOR_SLIAA_DISABLED)
                                                     ("ENABLED" , AA_MODE_SELECTOR_SLIAA_ENABLED )
                                                     ;

   //"Anisotropic filtering setting"
   dword_map[ANISO_MODE_LEVEL_ID] = map_list_of("MASK"       , ANISO_MODE_LEVEL_MASK       )
   ...
   dword_map[ANISO_MODE_SELECTOR_ID] = map_list_of("MASK", ANISO_MODE_SELECTOR_MASK)
   ...
   dword_map[APPLICATION_PROFILE_NOTIFICATION_TIMEOUT_ID] = map_list_of("DISABLED"       , APPLICATION_PROFILE_NOTIFICATION_TIMEOUT_DISABLED       )
   ...
   dword_map[CPL_HIDDEN_PROFILE_ID] = map_list_of("DISABLED", CPL_HIDDEN_PROFILE_DISABLED)
                                                 ("ENABLED" , CPL_HIDDEN_PROFILE_ENABLED )
                                                 ;

   //"List of Universal GPU ids"
   string_map[CUDA_EXCLUDED_GPUS_ID] = list_of(string((const char * )CUDA_EXCLUDED_GPUS_NONE));

   //"Maximum Allowed GPU Power"
   string_map[D3DOGL_GPU_MAX_POWER_ID] = list_of(string((const char * )D3DOGL_GPU_MAX_POWER_DEFAULTPOWER));

   //"Export Performance Counters"
   dword_map[EXPORT_PERF_COUNTERS_ID] = map_list_of("OFF", EXPORT_PERF_COUNTERS_OFF)
                                                   ("ON" , EXPORT_PERF_COUNTERS_ON )
                                                   ;

   //"NVIDIA Predefined FXAA Usage"
   dword_map[FXAA_ALLOW_ID] = map_list_of("DISALLOWED", FXAA_ALLOW_DISALLOWED)
                                         ("ALLOWED"   , FXAA_ALLOW_ALLOWED   )
                                         ;

   //"Toggle FXAA on or off"
   dword_map[FXAA_ENABLE_ID] = map_list_of("OFF", FXAA_ENABLE_OFF)
                                          ("ON" , FXAA_ENABLE_ON )
                                          ;

   //"Toggle FXAA Indicator on or off"
   dword_map[FXAA_INDICATOR_ENABLE_ID] = map_list_of("OFF", FXAA_INDICATOR_ENABLE_OFF)
                                                    ("ON" , FXAA_INDICATOR_ENABLE_ON )
                                                    ;

   //"Show the SLI on-screen indicator"
   dword_map[MCSFRSHOWSPLIT_ID] = map_list_of("DISABLED", MCSFRSHOWSPLIT_DISABLED)
                                             ("ENABLED" , MCSFRSHOWSPLIT_ENABLED )
                                             ;

   //"Debug bits for optimus"
   dword_map[OPTIMUS_DEBUG_ID] = map_list_of("RENDER_TRANSPORT" , OPTIMUS_DEBUG_NULL_RENDER_TRANSPORT )
                                            ("DISPLAY_TRANSPORT", OPTIMUS_DEBUG_NULL_DISPLAY_TRANSPORT)
                                            ;

   //"Maximum AA samples allowed for a given application"
   dword_map[OPTIMUS_MAXAA_ID] = map_list_of("MIN", OPTIMUS_MAXAA_MIN)
                                            ("MAX", OPTIMUS_MAXAA_MAX)
                                            ;

   //"Display the PhysX indicator"
   dword_map[PHYSXINDICATOR_ID] = map_list_of("DISABLED", PHYSXINDICATOR_DISABLED)
                                             ("ENABLED" , PHYSXINDICATOR_ENABLED )
                                             ;

   //"Power management mode"
   dword_map[PREFERRED_PSTATE_ID] = map_list_of("ADAPTIVE"  , PREFERRED_PSTATE_ADAPTIVE         )
   ...
   //"Frame Rate Limiter"
   dword_map[PS_FRAMERATE_LIMITER_ID] = map_list_of("DISABLED"            , PS_FRAMERATE_LIMITER_DISABLED            )
   ...
   //"iGPU transcoding"
   dword_map[SHIM_IGPU_TRANSCODING_ID] = map_list_of("DISABLE", SHIM_IGPU_TRANSCODING_DISABLE)
                                                    ("ENABLE" , SHIM_IGPU_TRANSCODING_ENABLE )
                                                    ;

   //"Optimus flags for enabled applications"
   dword_map[SHIM_MCCOMPAT_ID] = map_list_of("INTEGRATED"   , SHIM_MCCOMPAT_INTEGRATED   )
   ...
   dword_map[SHIM_RENDERING_MODE_ID] = map_list_of("INTEGRATED"   , SHIM_RENDERING_MODE_INTEGRATED   )
   ...
   dword_map[SHIM_RENDERING_OPTIONS_ID] = map_list_of("DEFAULT_RENDERING_MODE"    , SHIM_RENDERING_OPTIONS_DEFAULT_RENDERING_MODE    )
   ...
   dword_map[SLI_GPU_COUNT_ID] = map_list_of("AUTOSELECT", SLI_GPU_COUNT_AUTOSELECT)
   ...
   dword_map[SLI_PREDEFINED_GPU_COUNT_ID] = map_list_of("AUTOSELECT", SLI_PREDEFINED_GPU_COUNT_AUTOSELECT)
   ...
   dword_map[SLI_PREDEFINED_GPU_COUNT_DX10_ID] = map_list_of("AUTOSELECT", SLI_PREDEFINED_GPU_COUNT_DX10_AUTOSELECT)
   ...
   dword_map[SLI_PREDEFINED_MODE_ID] = map_list_of("AUTOSELECT"                     , SLI_PREDEFINED_MODE_AUTOSELECT                     )
   ...
   dword_map[SLI_PREDEFINED_MODE_DX10_ID] = map_list_of("AUTOSELECT"                     , SLI_PREDEFINED_MODE_DX10_AUTOSELECT                     )
   ...
   //"SLI rendering mode"
   dword_map[SLI_RENDERING_MODE_ID] = map_list_of("AUTOSELECT"                     , SLI_RENDERING_MODE_AUTOSELECT                     )
   ...
   dword_map[VSYNCSMOOTHAFR_ID] = map_list_of("OFF", VSYNCSMOOTHAFR_OFF)
                                             ("ON" , VSYNCSMOOTHAFR_ON )
                                             ;

   //"Vsync - Behavior Flags"
   dword_map[VSYNC_BEHAVIOR_FLAGS_ID] = map_list_of("NONE"                        , VSYNC_BEHAVIOR_FLAGS_NONE                        )
                                                   ("DEFAULT"                     , VSYNC_BEHAVIOR_FLAGS_DEFAULT                     )
                                                   ("IGNORE_FLIPINTERVAL_MULTIPLE", VSYNC_BEHAVIOR_FLAGS_IGNORE_FLIPINTERVAL_MULTIPLE)
                                                   ;

   //"Stereo - Swap eyes"
   dword_map[WKS_API_STEREO_EYES_EXCHANGE_ID] = map_list_of("OFF", WKS_API_STEREO_EYES_EXCHANGE_OFF)
                                                           ("ON" , WKS_API_STEREO_EYES_EXCHANGE_ON )
                                                           ;

   //"Stereo - Display mode"
   dword_map[WKS_API_STEREO_MODE_ID] = map_list_of("SHUTTER_GLASSES"             , WKS_API_STEREO_MODE_SHUTTER_GLASSES)
   ...
   //"Stereo - Win8 support"
   dword_map[WKS_FEATURE_SUPPORT_CONTROL_ID] = map_list_of("OFF"                          , WKS_FEATURE_SUPPORT_CONTROL_OFF                          )
   ...
   dword_map[WKS_STEREO_DONGLE_SUPPORT_ID] = map_list_of("OFF", WKS_STEREO_DONGLE_SUPPORT_OFF)
                                                        ("DAC", WKS_STEREO_DONGLE_SUPPORT_DAC)
                                                        ("DLP", WKS_STEREO_DONGLE_SUPPORT_DLP)
                                                        ;

   //"Stereo - Enable"
   dword_map[WKS_STEREO_SUPPORT_ID] = map_list_of("OFF", WKS_STEREO_SUPPORT_OFF)
                                                 ("ON" , WKS_STEREO_SUPPORT_ON )
                                                 ;

   //"Ambient Occlusion"
   dword_map[AO_MODE_ID] = map_list_of("OFF"   , AO_MODE_OFF   )
                                      ("LOW"   , AO_MODE_LOW   )
   ...
   dword_map[AO_MODE_ACTIVE_ID] = map_list_of("DISABLED", AO_MODE_ACTIVE_DISABLED)
                                             ("ENABLED" , AO_MODE_ACTIVE_ENABLED )
                                             ;

   //"Texture filtering - Driver Controlled LOD Bias"
   dword_map[AUTO_LODBIASADJUST_ID] = map_list_of("OFF", AUTO_LODBIASADJUST_OFF)
                                                 ("ON" , AUTO_LODBIASADJUST_ON )
                                                 ;

   //"Texture filtering - LOD Bias"
   dword_map[LODBIASADJUST_ID] = map_list_of("MIN", LODBIASADJUST_MIN)
                                            ("MAX", LODBIASADJUST_MAX)
                                            ;

   //"Maximum pre-rendered frames"
   dword_map[PRERENDERLIMIT_ID] = map_list_of("MIN"           , PRERENDERLIMIT_MIN           )
                                             ("MAX"           , PRERENDERLIMIT_MAX           )
                                             ("APP_CONTROLLED", PRERENDERLIMIT_APP_CONTROLLED)
                                             ;

   //"Dynamic tiling"
   dword_map[PS_DYNAMIC_TILING_ID] = map_list_of("OFF", PS_DYNAMIC_TILING_OFF)
                                                ("ON" , PS_DYNAMIC_TILING_ON )
                                                ;

   //"Texture filtering - Anisotropic sample optimization"
   dword_map[PS_TEXFILTER_ANISO_OPTS2_ID] = map_list_of("OFF", PS_TEXFILTER_ANISO_OPTS2_OFF)
                                                       ("ON" , PS_TEXFILTER_ANISO_OPTS2_ON )
                                                       ;

   //"Texture filtering - Anisotropic filter optimization"
   dword_map[PS_TEXFILTER_BILINEAR_IN_ANISO_ID] = map_list_of("OFF", PS_TEXFILTER_BILINEAR_IN_ANISO_OFF)
                                                             ("ON" , PS_TEXFILTER_BILINEAR_IN_ANISO_ON )
                                                             ;

   //"Texture filtering - Trilinear optimization"
   dword_map[PS_TEXFILTER_DISABLE_TRILIN_SLOPE_ID] = map_list_of("OFF", PS_TEXFILTER_DISABLE_TRILIN_SLOPE_OFF)
                                                                ("ON" , PS_TEXFILTER_DISABLE_TRILIN_SLOPE_ON )
                                                                ;

   //"Texture filtering - Negative LOD bias"
   dword_map[PS_TEXFILTER_NO_NEG_LODBIAS_ID] = map_list_of("OFF", PS_TEXFILTER_NO_NEG_LODBIAS_OFF)
                                                          ("ON" , PS_TEXFILTER_NO_NEG_LODBIAS_ON )
                                                          ;

   //"Texture filtering - Quality"
   dword_map[QUALITY_ENHANCEMENTS_ID] = map_list_of("HIGHQUALITY"    , QUALITY_ENHANCEMENTS_HIGHQUALITY    )
   ...
   dword_map[REFRESH_RATE_OVERRIDE_ID] = map_list_of("APPLICATION_CONTROLLED", REFRESH_RATE_OVERRIDE_APPLICATION_CONTROLLED)
                                                    ("HIGHEST_AVAILABLE"     , REFRESH_RATE_OVERRIDE_HIGHEST_AVAILABLE     )
                                                    ;

   //"PowerThrottle"
   dword_map[SET_POWER_THROTTLE_FOR_PCIe_COMPLIANCE_ID] = map_list_of("OFF", SET_POWER_THROTTLE_FOR_PCIe_COMPLIANCE_OFF)
                                                                     ("ON" , SET_POWER_THROTTLE_FOR_PCIe_COMPLIANCE_ON )
                                                                     ;

   //"VAB Default Data"
   dword_map[SET_VAB_DATA_ID] = map_list_of("ZERO"            , SET_VAB_DATA_ZERO            )
   ...
   //"Vertical Sync"
   dword_map[VSYNCMODE_ID] = map_list_of("PASSIVE"      , VSYNCMODE_PASSIVE      )
   ...
   dword_map[VSYNCTEARCONTROL_ID] = map_list_of("DISABLE", VSYNCTEARCONTROL_DISABLE)
                                               ("ENABLE", VSYNCTEARCONTROL_ENABLE)
                                               ;
}


unsigned int nv_api::get_value_id_from_setting_id( NvU32 id, string const & value_name )
{
   //if (dword_map[id].)
   //   return 1;
